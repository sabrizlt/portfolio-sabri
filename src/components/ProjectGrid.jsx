...
const projects = [
  ...
  },
  {
    ...
    link: "https://web-appointment.com",
    type: "Production"
  },
  {
    id: 3,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {projects.map((project) => (
        <div
          key={project.id}
          className="p-8 bg-black border border-neutral-900 hover:border-emerald-500/40 transition-all duration-300 group flex flex-col justify-between"
        >
          <div>
          ...
          <div className="mt-8 space-y-6">
            <div className="flex flex-wrap gap-2">
              {project.tags.map((tag) => (
                <span key={tag} className="text-[11px] font-mono bg-neutral-950 text-neutral-500 px-2.5 py-1 border border-neutral-900">
                  {tag}
                </span>
              ))}
            </div>
